...
- **Hover anything.** Point at a planet or the Sun for its size, distance, day length and moons; hover the in-flight rocket for projected SpaceX **Starship** specs (engines, propellant, payload, crew) and its **live speed** — in km/s and as a fraction of light speed (also shown in the flight HUD).
